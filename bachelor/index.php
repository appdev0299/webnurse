...
<body>
    ...
    <main>
        ...
        <!-- breadcrumb-section - start
			================================================== -->
        <section id="breadcrumb-section" class="breadcrumb-section d-flex align-items-center decoration-wrap clearfix"
            data-background="../assets/images/background/bg_1.jpg">
            <div class="container text-center">
                <h1 class="page-title mb-3">Shop Details</h1>
                <div class="breadcrumb-nav ul-li-center clearfix">
                    <ul class="clearfix">
                        <li><a href="index.html">Home</a></li>
                        <li><a href="shop-grid-3-column.html">Shop</a></li>
                        <li class="active">Shop Details V.4</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="details-section sec-ptb-100 pb-0 clearfix">
            <div class="container">
                ...
                <div class="section-title text-center mb-70">
                    <h2 class="title-text mb-3">หลักสูตรระดับปริญญาตรี</h2>
                </div>
                ...
                <div class="information-area">
                    <div class="tabs-nav ul-li mb-40">
                        <ul class="nav" role="tablist">
                            <li>
                                <a class="active" data-toggle="tab" href="#description-tab">รายละเอียด</a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#information-tab">อัตราค่าธรรมเนียมการศึกษา</a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#reviews-tab">แผนการศึกษา</a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#lecturer-tab">อาจารย์ประจำหลักสูตร</a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#recruitment-tab">การรับสมัคร</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content">
                        <div id="description-tab" class="tab-pane active">
                            <h3 class="title-text mb-30">รายละเอียดหลักสุตร</h3>
                            <div class="table-wrap">
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <td><strong>หลักสูตรผ่านการรับรองโดย</strong></td>
                                            <td>สภามหาวิทยาลัยอนุมัติหลักสูตรพยาบาลศาสตรบัณฑิต เมื่อวันที่ 17 ธันวาคม
                                                พ.ศ. 2563</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><strong>ชื่อหลักสูตร</strong></td>
                                            <td>ภาษาไทย: หลักสูตรพยาบาลศาสตรบัณฑิต </td>
                                            <td>ภาษาอังกฤษ: Bachelor of Nursing Science Program</td>
                                        </tr>
                                        <tr>
                                            <td><strong>ชื่อปริญญา</strong></td>
                                            <td>ชื่อปริญญาภาษาไทย: พยาบาลศาสตรบัณฑิต </td>
                                            <td>ชื่อปริญญาภาษาอังกฤษ: Bachelor of Nursing Science</td>
                                        </tr>
                                        <tr>
                                            <td><strong>ชื่อย่อปริญญา</strong></td>
                                            <td>อักษรย่อภาษาไทย: พย.บ. </td>
                                            <td>อักษรย่อภาษาอังกฤษ: B.N.S.</td>
                                        </tr>
                                        <tr>
                                            <td><strong>ระยะเวลาการศึกษา</strong></td>
                                            <td>ระยะเวลาการศึกษาไม่น้อยกว่า 4 ปีการศึกษา/ 8 ภาคการศึกษาปกติแต่ไม่เกิน 8
                                                ปีการศึกษา จำนวนหน่วยกิตรวม ตลอดหลักสูตร ไม่น้อยกว่า 136 หน่วยกิต</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><strong>โครงสร้างหลักสูตร</strong></td>
                                            <td>หมวดวิชาศึกษาทั่วไป ไม่น้อยกว่า</td>
                                            <td>30 หน่วยกิต</td>
                                        </tr>
                                        <tr>
                                            <td><strong></strong></td>
                                            <td>หมวดวิชาเฉพาะ ไม่น้อยกว่า</td>
                                            <td>20 หน่วยกิต</td>
                                        </tr>
                                        <tr>
                                            <td><strong></strong></td>
                                        ...
                                        <tr>
                                            <td><strong></strong></td>
                                            <td>- รายวิชาปฏิบัติ</td>
                                            <td>36 หน่วยกิต</td>
                                        </tr>
                                        <tr>
                                            <td><strong></strong></td>
                                            <td>หมวดวิชาเลือกเสรี ไม่น้อยกว่า</td>
                                            <td>6 หน่วยกิต</td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div id="information-tab" class="tab-pane fade">
                            <h3 class="title-text mb-30">อัตราค่าธรรมเนียมการศึกษา</h3>
                            <div class="table-wrap">
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <td><strong>หลักสูตรพยาบาลศาสตรบัณฑิต(หลักสุตรปรับปรุง พ.ศ. 2559)</strong>
                                            </td>
                                            <td></td>
                                            <td>ตลอดหลักสูตร</td>
                                            <td>217,670</td>
                                            <td>การเก็บค่าบำรุงและค่าธรรมเนียมแบบค่าหน่วยกิตตามรายวิชาที่เข้าศึกษาตั้งแต่ปีการศึกษา
                                                2559-2563</td>
                                        </tr>
                                        <tr>
                                            <td><strong>หลักสูตรพยาบาลศาสตรบัณฑิต (หลักสูตรปรับปรุง พ.ศ. 2564)</strong>
                                            </td>
                                            <td></td>
                                            <td>ตลอดหลักสูตร</td>
                                            <td>217,670</td>
                                            <td>การเก็บเงินค่าบำรุงและค่าธรรมเนียมการศึกษา แบบเหมาจ่าย
                                                ระดับปริญญาตรีคณะพยาบาลศาสตร์ พ.ศ. 2563ที่เข้าศึกษาตั้งแต่ภาคต้น
                                                ปีการศึกษา 2564 เป็นต้นไป</td>
                                        </tr>
                                        <tr>
                                            <td><strong>สำหรับนิสิตภาคปกติ นิสิตไทย</strong></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td><strong>สำหรับนิสิตภาคปกติ นิสิตต่างชาติ</strong></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                        ...
                        <div id="reviews-tab" class="tab-pane fade">
                            <h3 class="title-text mb-30">แผนการศึกษา</h3>
                            <div class="table-wrap">
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <td><strong>ศึกษาทั่วไป</strong></td>
                                            <td>89520564</td>
                                            <td>ภาษาอังกฤษระดับมหาวิทยาลัย</td>
                                            <td>3 (2-2-5)</td>
                                        </tr>
                                        <tr>
                                            <td><strong></strong></td>
                                            <td>89510264</td>
                                            <td>ความสุขและคุณค่าชีวิต</td>
                                            <td>2 (1-2-3)</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td><strong>วิชาเฉพาะ</strong></td>
                                            <td>68010364</td>
                                            <td>กายวิภาคศาสตร์พื้นฐานของมนุษย์</td>
                                            <td>2 (2-0-4)</td>
                                        </tr>
                                        <tr>
                                            <td><strong></strong></td>
                                            <td>68010464</td>
                                            <td>ปฏิบัติการกายวิภาคศาสตร์พื้นฐานของมนุษย์</td>
                                            <td>1 (0-3-1)</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>30510164</td>
                                            <td>จุลชีววิทยาและปรสิตวิทยา</td>
                                            <td>2 (1-2-3)</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            <td><strong>รวม (Total)</strong></td>
                                            <td>19 (12-15-31)</td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div id="lecturer-tab" class="tab-pane fade">
                            <section class="shop-section sec-ptb-50 pb-0 decoration-wrap clearfix">
                                <div class="container">
                        ...
                        <div id="recruitment-tab" class="tab-pane fade">
                            <h3 class="title-text mb-30">การรับสมัคร</h3>
                            <div class="table-wrap">
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <td><strong>คุณสมบัติของผู้เข้าศึกษา</strong></td>
                                            <td>เป็นผู้สำเร็จการศึกษามัธยมศึกษาตอนปลายหรือเทียบเท่า</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><strong></strong></td>
                                            <td>มีเกณฑ์คุณสมบัติเพิ่มเติม คือ มีคะแนนเฉลี่ยสะสมระดับมัธยมศึกษาตอนปลายไม่ต่ำกว่า 2.50</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><strong>การสมัครในแต่ละรูปแบบ</strong></td>
                                            <td>รับนิสิตด้วย portfolio สมัครออนไลน์ ผ่าน http://regservice.buu.ac.th/</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><strong></strong></td>
                                            <td>การรับนิสิตระบบโค้วต้า สมัครออนไลน์ ผ่าน http://regservice.buu.ac.th/</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><strong></strong></td>
                                            <td>รับตรง ร่วมกับ ทปอ. สมัครออนไลน์ ผ่าน http://regservice.buu.ac.th/</td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><strong></strong></td>
                                            <td>ระบบ Admissions สมัครออนไลน์ ผ่าน http://regservice.buu.ac.th/</td>
                                            <td></td>
                                        </tr>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                        <div class="payment-cards ul-li mb-30 clearfix">
                            ...
                            <ul class="mb-3 clearfix">
                                <li><a href="#!"><img src="../assets/images/payment_card/card_1.png"
                                            alt="_not_found"></a></li>
                                <li><a href="#!"><img src="../assets/images/payment_card/card_2.png"
                                            alt="_not_found"></a></li>
                                <li><a href="#!"><img src="../assets/images/payment_card/card_3.png"
                                            alt="_not_found"></a></li>
                                <li><a href="#!"><img src="../assets/images/payment_card/card_4.png"
                                            alt="_not_found"></a></li>
                                <li><a href="#!"><img src="../assets/images/payment_card/card_5.png"
                                            alt="_not_found"></a></li>
                            </ul>
